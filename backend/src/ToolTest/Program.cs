...
namespace ToolTest
{
    internal class Program
    {
        ...
        public static async Task MainAsync(string[] args)
        {
            ...
            //var p赔偿订单 = @"C:\Users\Leon\Desktop\5月赔偿订单5月12号导出 - 副本.xlsx";
            //var p退货订单 = @"C:\Users\Leon\Desktop\5月退货订单5月12号导出.xlsx";
            ...
            //var handler = new CompensationHandler(p赔偿订单, null, p处理方案, p部门映射, p店铺更名匹配, pMSKU2SKU, pSKU价格匹配, p汇率匹配, exportFolder);
