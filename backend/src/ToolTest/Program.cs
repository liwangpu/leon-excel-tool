...
namespace ToolTest
{
    internal class Program
    {
        ...
        public static async Task MainAsync(string[] args)
        {
            ...
            var p退货订单 = @"C:\Users\Leon\Desktop\退货订单3.7-3.16原数据.xlsx";
            ...
            var handler = new CompensationHandler(null, p退货订单, p处理方案, p部门映射, p店铺更名匹配, pMSKU2SKU, pSKU价格匹配, exportFolder);
            ...
            //var p赔偿订单 = @"C:\Users\Leon\Desktop\3月份赔偿报表所有.xlsx";
